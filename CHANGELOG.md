...
Este layout está en fase activa de desarrollo. No se ha publicado aún una versión beta o estable.
...
- `1.0.0-beta`: Primer versión beta con documentación, variantes completas y assets optimizados
- `1.0.0`: Publicación estable con fallback automático de templates, validaciones y optimización SEO
